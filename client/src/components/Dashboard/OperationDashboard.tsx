...
class OperationDashboard extends Component<any, any> {
  ...
  render () {
    const ThaliCountReportLink = (props:any) => <Link to="/operation/tahli-count-report" {...props} />
    return (
      <div>
        ...
        <div className="Dashboard-card-container">
          ...
          <div className="Dashboard-button-row-container">
            <div className="Dashboard-button-row">
              ...
              <div className="Dashboard-button-container">
                <Button component={ThaliCountReportLink} variant="contained" color="secondary" className="Dashboard-button">
                <span className="Dashboard-button-content-container">   
