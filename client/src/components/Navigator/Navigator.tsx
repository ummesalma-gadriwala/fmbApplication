...
class Navigator extends Component<any, any> {
  ...
  render() {
    ...
    const OperationDashBoardLink = (props:any) => <Link to="/operation/dashboard" {...props} />
            ...
            <AppBar position="fixed" color="primary" className= { this.props.classes.appBar } >
              <Toolbar >
               ...
               { doesUserBelongsToOperation(this.props.roles) &&
                <IconButton component={OperationDashBoardLink}  color="inherit" aria-label="Show Notifications">
                    <OperationIcon color="inherit" aria-label="Open Operation Dashboard" />
                </IconButton>
               }
                <IconButton component={UserProfileLink} color="inherit" aria-label="Open Dashboard">
                   <PersonOutlineIcon />
                </IconButton>
