...
class SubscriptionInfo extends React.Component<any, any> {
  ...
  render() {
    ...
    const buildSchedule = () => {
      return this.state.thaliSchedule &&
        Object.keys(this.state.thaliSchedule).length > 0
        ? Object.keys(this.state.thaliSchedule).map((day: any, index) => {
            return (
              <TableRow key={index}>
                ...
                <TableCell align="right">
                  <Select
                    ...
                    //@ts-ignore
                    value={
                      this.state && this.state.thaliSchedule[day]
                        ? this.state.thaliSchedule[day]
                        : ''
                    }
      ...
      <div>
        ...
        <Paper className="Margin-Container">
          <Table>
            ...
            <TableBody>{buildSchedule()}</TableBody>
          </Table>
        </Paper>
...
export default requireAuth(
  connect(mapStateToProps, mealscheduleAction)(SubscriptionInfo)
);
